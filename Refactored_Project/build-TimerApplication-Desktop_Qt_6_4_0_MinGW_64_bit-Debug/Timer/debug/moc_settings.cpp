...
#include <memory>
#include "../../../TimerApplication/Timer/settings.h"
...
Q_CONSTINIT static const qt_meta_stringdata_Settings_t qt_meta_stringdata_Settings = {
    {
        ...
        QT_MOC_LITERAL(9, 6),  // "infoOk"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 18)   // "showSettingsWindow"
    },
    "Settings",
    "infoOk",
    "",
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { bool _r = _t->infoOk();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->showSettingsWindow(); break;
        default: ;
        }
    }
}
